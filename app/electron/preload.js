...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  onShortcutBookmark: (callback) => ipcRenderer.on('shortcut-bookmark', () => callback()),
  onShortcutPrint: (callback) => ipcRenderer.on('shortcut-print', () => callback()),
  onShortcutClearData: (callback) => ipcRenderer.on('shortcut-clear-data', () => callback()),
